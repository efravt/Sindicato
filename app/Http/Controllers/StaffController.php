...
class StaffController extends Controller
{
		...
		return datatables()
                ...
                ->addColumn('action','
					...
					<a href="{{ route(\'staff.pdf\',$codigo) }}">
						<button class="btn btn-icon btn-danger btn-sm waves-effect waves-ligh" type="button" title="pdf">
	...
	public function pdf($id){
		...
		$vehiculo1 = Vehiculo::where('cod_socio', $id)->where('tipo', 1)->first();
		$vehiculos_apoyo = Vehiculo::where('cod_socio', $id)->where('tipo', 2)->get();
		$pdf = Pdf::setPaper('letter')->loadView('staff.pdf',compact('staff', 'vehiculo1', 'vehiculos_apoyo'));
        return $pdf->stream();
