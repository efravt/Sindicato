                                    ...
                                    <div class="card rounded-0 mb-0 px-2 ">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="mb-0">Ingresar al Sistema</h4>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body pt-1">
                                                <form id="form" method="POST" action="#">
                                                    ...
                                                    <fieldset class="form-group position-relative has-icon-left">
                                                        <input id="email" type="email" class="form-control in" name="email" autocomplete="off" autofocus placeholder="Ingresar Email">
                                                    ...
                                                    <fieldset class="form-label-group position-relative has-icon-left">
                                                        <input id="password" type="password" class="form-control in" placeholder="Ingresar Contraseña" autocomplete="off" name="password" autocomplete="current-password">
                                                        <div class="form-control-position">
                                                ...
                                                <br>
                                                {{-- Sección para visualizar errores --}}
            ...
            submitHandler: function(){
                ...
                $.ajax({
                    ...
                    error: function(xhr, status){
                        $('#error-back').html('');
                        $(".btn-block").html(`INGRESAR`).attr("disabled",false);
                        Swal.fire({
                            title: 'Error!',
