                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text" autocomplete="off" id="name" name="name" class="form-control" placeholder="Introduzca descripción de Red Social">
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <span class="required-input">*</span>
                                        <label class="text-show">Link:</label>
                                        <input type="text" autocomplete="off" id="url" name="url" class="form-control" placeholder="Introduzca ruta de Red Social">
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <span class="required-input">*</span>
                                        ...
                                        <select name="social_id" class="form-control" id="social_id">
                                            ...
                                            @foreach($socials as $social)
                                                <option value="{{ $social->social_id }}">{{ $social->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-12 text-right mt-2 cancel_form">
                                        ...
                                        <a href="{{ route('staffSocial.get', $staff->staff_id) }}">
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        Swal.fire({
                            ...
                            if(result.value){
                                location.href = "{{ route('staffSocial.get', $staff->staff_id) }}";
                            }
                        });
                    },
