                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input type="text" autocomplete="off" id="description" name="description" class="form-control" placeholder="Introduzca descripción">
                                    </div>
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        Swal.fire({
                            ...
                            if(result.value){
                                location.href = "{{ route('staffDetail.get', $staff->staff_id) }}";
                            }
                        });
                    },
