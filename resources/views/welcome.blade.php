                            ...
                            <div class="card-content">
                                <div class="card-body text-center">
                                    ...
                                    <div class="text-center">
                                        <h1 class="mb-2 text-white">Bienvenido {{Auth::user()->name}} {{Auth::user()->paternal}},</h1>
                                        <p class="m-auto w-75">"La única forma de amar tu trabajo, es amar lo que haces". Steve Jobs</p>
                                    </div>
                                </div>
                            </div>
                        </div>
